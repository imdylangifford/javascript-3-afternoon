...
//Code Here
let myStrongest  = monstersInYourPocket.filter(i => i.CP > 200)
...
let ordersTotal = orders.map(order => order + order.tax)
ordersTotal
...
let bobsTotal = purchases.filter(el => el.owner === "Bob").reduce((a,e) => a + e.price,0)
